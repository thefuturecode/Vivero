...
class ProveedorControllerTest {
	...
	// Eliminación lógica
	// Caso exitoso: el proveedor es encontrado y eliminado. Se devuelve un status code 200
	@Test
	void siElProveedorEsEncontradoYEliminadoEntoncesLaOperacionSeRealizaExitosamenteYSeRetornaOK() throws Exception {
		// when
		MockHttpServletResponse response = mockMvc.perform(get("/proveedores/eliminar/2").accept(MediaType.APPLICATION_JSON))
	...
	// Caso fallido: el proveedor no es encontrado y servicio lanza excepción. Se devuelve status code 404
	@Test
